					...
					<div class="panel-body">
						<form class="form-signin" method="post" action="">
							...
							<div>
								...
								<option value=''>-</option>
								<option name="MCA" value="MCA">MCA</option>
								<option name="MSc" value="MSc">MSc</option>
								<option name="BCA" value="BCA">BCA</option>
								<option name="BTech" value="BTech">B.Tech</option>
								...
								<option value=''>-</option>
								<option name="SU" value="SU">SU</option>
								<option name="SGTU" value="SGTU">SGTU</option>
								</select>
